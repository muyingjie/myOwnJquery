 ...
 */
// map对象也用于遍历，与each的区别在于会搜集遍历函数的返回值并将其放到一个新的数组中去
// 需要注意：我们顺序自己封装的map参数顺序和jQuery中正好相反，因为我个人在学习jQuery的时候遇到很多遍历函数：
// each map grep，但是参数顺序有区别，造成记忆上的不便，因此我在这里设计成了一种形式
(function (window) {
    ...
    mQuery.map = function (o, fn, context) {
        var res = [];
        if (typeof o == "object") {
            if (o.length != undefined && o.length > 0) {
                // 数组
